...
############################################
    ...
    def build_quadrature(self):
        ...
        #Get defects quadrature
        xd, yd, wd = self.build_defects_quadrature()

        #Add to quadrature
        self.xq = np.concatenate((self.xq, xd))
        self.yq = np.concatenate((self.yq, yd))
        self.wq = np.concatenate((self.wq, wd))
