...
def starshade_quad(Afunc, num_pet, r0, r1, m, n, is_opaque=True):
    """
    ...
    Inputs:
        ...
        is_opaque = does the starshade have an opaque central disc? i.e., invokes Babinet's Principle (common)
